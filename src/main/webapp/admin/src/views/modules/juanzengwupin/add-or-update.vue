	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="捐赠地点" prop="juanzengdidian">
					<el-input v-model="ruleForm.juanzengdidian" placeholder="捐赠地点" clearable  :readonly="ro.juanzengdidian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="捐赠地点" prop="juanzengdidian">
					<el-input v-model="ruleForm.juanzengdidian" placeholder="捐赠地点" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="捐赠日期" prop="juanzengriqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.juanzengriqi" 
						type="date"
						:readonly="ro.juanzengriqi"
						placeholder="捐赠日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.juanzengriqi" label="捐赠日期" prop="juanzengriqi">
					<el-input v-model="ruleForm.juanzengriqi" placeholder="捐赠日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="捐赠账号" prop="juanzengzhanghao">
					<el-input v-model="ruleForm.juanzengzhanghao" placeholder="捐赠账号" clearable  :readonly="ro.juanzengzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="捐赠账号" prop="juanzengzhanghao">
					<el-input v-model="ruleForm.juanzengzhanghao" placeholder="捐赠账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="捐赠姓名" prop="juanzengxingming">
					<el-input v-model="ruleForm.juanzengxingming" placeholder="捐赠姓名" clearable  :readonly="ro.juanzengxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="捐赠姓名" prop="juanzengxingming">
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				juanzengdidian: [
					{ required: true, message: '捐赠地点不能为空', trigger: 'blur' },
				],
				juanzengriqi: [
				],
				juanzengzhanghao: [
	...
	created() {
		this.ruleForm.juanzengriqi = this.getCurDate()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='juanzengdidian'){
							this.ruleForm.juanzengdidian = obj[o];
							this.ro.juanzengdidian = true;
							continue;
						}
						if(o=='juanzengriqi'){
							this.ruleForm.juanzengriqi = obj[o];
							this.ro.juanzengriqi = true;
							continue;
						}
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(json.juanzengzhanghao!=''&&json.juanzengzhanghao && this.$storage.get("role")!="管理员"){
						this.ruleForm.juanzengzhanghao = json.juanzengzhanghao
						this.ro.juanzengzhanghao = true;
					}
					if(json.juanzengxingming!=''&&json.juanzengxingming && this.$storage.get("role")!="管理员"){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `juanzengwupin/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.juanzengwupinCrossAddOrUpdateFlag = false;
						 this.parent.search();
