...
<div :style='{"width":"1000px","padding":"20px","margin":"10px auto","position":"relative","background":"#D8D8D8"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="物品图片" prop="wupintupian">
            <file-upload
            tip="点击上传物品图片"
            action="file/upload"
            :limit="3"
          ...
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="捐赠地点" prop="juanzengdidian">
            <el-input v-model="ruleForm.juanzengdidian" 
                placeholder="捐赠地点" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="捐赠日期" prop="juanzengriqi" >
              <el-date-picker
          ...
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="捐赠账号" prop="juanzengzhanghao">
            <el-input v-model="ruleForm.juanzengzhanghao" 
                placeholder="捐赠账号" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="捐赠姓名" prop="juanzengxingming">
            <el-input v-model="ruleForm.juanzengxingming" 
                placeholder="捐赠姓名" clearable ></el-input>
          </el-form-item>
...
<script>
  export default {
      ...
      init(type) {
        ...
        this.$http.get(this.userTableName + '/session', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            ...
            if(json.juanzengzhanghao!=''&&json.juanzengzhanghao){
                this.ruleForm.juanzengzhanghao = json.juanzengzhanghao
            }
            if(json.juanzengxingming!=''&&json.juanzengxingming){
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('juanzengwupin/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('juanzengwupin/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('juanzengwupin/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
