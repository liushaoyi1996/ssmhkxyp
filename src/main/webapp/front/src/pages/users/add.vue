...
<div :style='{"width":"1000px","padding":"20px","margin":"10px auto","position":"relative","background":"#D8D8D8"}'>
    <el-form
      ...
      label-width="110px"
    >
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="用户名" prop="username">
            <el-input v-model="ruleForm.username" 
                placeholder="用户名" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="密码" prop="password">
            <el-input v-model="ruleForm.password" 
                placeholder="密码" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 2% 10px","display":"inline-block"}' label="角色" prop="role">
