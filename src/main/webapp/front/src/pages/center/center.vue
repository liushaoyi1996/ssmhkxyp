    ...
    <el-tabs tab-position="left" :style='{"background":"#BECCBA"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="110px">
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 0 10px","background":"#fff","display":"inline-block"}' v-if="userTableName=='juanzengzhe'" label="捐赠账号" prop="juanzengzhanghao">
            <el-input v-model="sessionForm.juanzengzhanghao" placeholder="捐赠账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 0 10px","background":"#fff","display":"inline-block"}' v-if="userTableName=='juanzengzhe'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 0 10px","background":"#fff","display":"inline-block"}' v-if="userTableName=='juanzengzhe'" label="捐赠姓名" prop="juanzengxingming">
            <el-input v-model="sessionForm.juanzengxingming" placeholder="捐赠姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 0 10px","background":"#fff","display":"inline-block"}' v-if="userTableName=='juanzengzhe'" label="头像">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              :show-file-list="false"
              :on-success="juanzengzhetouxiangHandleAvatarSuccess">
          ...
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 0 10px","background":"#fff","display":"inline-block"}' v-if="userTableName=='juanzengzhe'" label="性别">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 0 10px","background":"#fff","display":"inline-block"}' v-if="userTableName=='juanzengzhe'" label="联系电话" prop="lianxidianhua">
            <el-input v-model="sessionForm.lianxidianhua" placeholder="联系电话" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 0 10px","background":"#fff","display":"inline-block"}' v-if="userTableName=='juanzengzhe'" label="邮箱" prop="youxiang">
            <el-input v-model="sessionForm.youxiang" placeholder="邮箱" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 0 10px","background":"#fff","display":"inline-block"}' v-if="userTableName=='shenlingzhe'" label="申领账号" prop="shenlingzhanghao">
            <el-input v-model="sessionForm.shenlingzhanghao" placeholder="申领账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 0 10px","background":"#fff","display":"inline-block"}' v-if="userTableName=='shenlingzhe'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 0 10px","background":"#fff","display":"inline-block"}' v-if="userTableName=='shenlingzhe'" label="申领姓名" prop="shenlingxingming">
            <el-input v-model="sessionForm.shenlingxingming" placeholder="申领姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 0 10px","background":"#fff","display":"inline-block"}' v-if="userTableName=='shenlingzhe'" label="头像">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              :show-file-list="false"
              :on-success="shenlingzhetouxiangHandleAvatarSuccess">
              <img :style='{"border":"1px dashed #BECCBA","cursor":"pointer","color":"#BECCBA","borderRadius":"6px","textAlign":"center","width":"100px","fontSize":"32px","lineHeight":"100px","height":"100px"}' v-if="sessionForm.touxiang" :src="baseUrl + sessionForm.touxiang" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 0 10px","background":"#fff","display":"inline-block"}' v-if="userTableName=='shenlingzhe'" label="性别">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 0 10px","background":"#fff","display":"inline-block"}' v-if="userTableName=='shenlingzhe'" label="手机号码" prop="shoujihaoma">
            <el-input v-model="sessionForm.shoujihaoma" placeholder="手机号码" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"40%","padding":"10px","margin":"0 0 10px","background":"#fff","display":"inline-block"}' v-if="userTableName=='shenlingzhe'" label="邮箱" prop="youxiang">
            <el-input v-model="sessionForm.youxiang" placeholder="邮箱" ></el-input>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if ('juanzengzhe' == this.userTableName) {
        this.$set(this.sessionForm, 'juanzengxingming', null);
      }
      if ('juanzengzhe' == this.userTableName) {
      ...
      if ('shenlingzhe' == this.userTableName) {
        this.$set(this.sessionForm, 'shenlingzhanghao', null);
      }
      if ('shenlingzhe' == this.userTableName) {
        this.$set(this.sessionForm, 'mima', null);
      }
      if ('shenlingzhe' == this.userTableName) {
        this.$set(this.sessionForm, 'shenlingxingming', null);
      }
      if ('shenlingzhe' == this.userTableName) {
        this.$set(this.sessionForm, 'touxiang', null);
      }
      ...
      if ('juanzengzhe' == this.userTableName) {
        this.$set(this.rules, 'juanzengxingming', [{ required: true, message: '请输入捐赠姓名', trigger: 'blur' }]);
      }
			if ('juanzengzhe' == this.userTableName) {
      ...
      if ('shenlingzhe' == this.userTableName) {
        this.$set(this.rules, 'shenlingzhanghao', [{ required: true, message: '请输入申领账号', trigger: 'blur' }]);
      }
      if ('shenlingzhe' == this.userTableName) {
        this.$set(this.rules, 'mima', [{ required: true, message: '请输入密码', trigger: 'blur' }]);
      }
      if ('shenlingzhe' == this.userTableName) {
        this.$set(this.rules, 'shenlingxingming', [{ required: true, message: '请输入申领姓名', trigger: 'blur' }]);
      }
			if ('shenlingzhe' == this.userTableName) {
    ...
    methods: {
      ...
      juanzengzhetouxiangHandleAvatarSuccess(res, file) {
        if (res.code == 0) {
          if ('juanzengzhe' == this.userTableName) {
      ...
      shenlingzhetouxiangHandleAvatarSuccess(res, file) {
        if (res.code == 0) {
          if ('shenlingzhe' == this.userTableName) {
            this.sessionForm.touxiang = 'upload/' + res.file;
          }
