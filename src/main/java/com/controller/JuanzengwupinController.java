...
public class JuanzengwupinController {
    ...
    public R page(@RequestParam Map<String, Object> params,JuanzengwupinEntity juanzengwupin, 
		...
		if(tableName.equals("juanzengzhe")) {
			juanzengwupin.setJuanzengzhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<JuanzengwupinEntity> wrapper = new EntityWrapper<JuanzengwupinEntity>();
		if(map.get("remindstart")!=null) {
		...
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("juanzengzhe")) {
			wrapper.eq("juanzengzhanghao", (String)request.getSession().getAttribute("username"));
		}

		int count = juanzengwupinService.selectCount(wrapper);
